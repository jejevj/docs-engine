                ...
                <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
                    ...
                    <div class="menu menu-rounded menu-column menu-lg-row menu-active-bg menu-title-gray-600 menu-state-primary menu-arrow-gray-500 fw-semibold fw-semibold fs-6 align-items-stretch my-5 me-20 my-lg-0 px-2 px-lg-0"
                        ...
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                            ...
                            class="menu-item menu-lg-down-accordion me-lg-2 {{ Route::currentRouteName() == 'home' ? 'here show menu-here-bg' : '' }}">
                        ...
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                            ...
                            class="menu-item menu-lg-down-accordion me-lg-2 {{ Route::currentRouteName() == 'manajemen.index' ? 'here show menu-here-bg' : '' }}">

                            <!--begin:Menu link-->
                            <a href="{{ route('manajemen.index') }}" class="menu-link {{ Route::currentRouteName() == 'manajemen.index' ? 'active' : '' }}">
                                <span class="menu-icon">
                                    <i class="ki-duotone ki-questionnaire-tablet fs-3">
