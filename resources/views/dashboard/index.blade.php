            ...
            <div class="mb-10">
                ...
                <div class="text-center mb-15">
                    ...
                    <div class="fs-5 text-muted fw-semibold">
                        This is a Content Management System (CMS) application designed to manage zakat distribution data and
                        integrate with Docusaurus for documentation deployment. The system connects to the Data Terpadu
                        Sosial Ekonomi Nasional (DTSEN) to verify beneficiaries based on NIK, address, and socio-economic
